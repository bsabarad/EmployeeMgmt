...
namespace EmployeeMgmt.Controllers
{
    public class EmployeeSalariesController : Controller
    {
        ...
        public EmployeeSalariesController(EmployeeMgmtContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.EmployeeSalary.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var employeeSalary = await _context.EmployeeSalary
        ...
        public async Task<IActionResult> Create([Bind("Id,SalaryDate,Amount,EmployeeId,CreatedDate")] EmployeeSalary employeeSalary)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SalaryDate,Amount,EmployeeId,CreatedDate")] EmployeeSalary employeeSalary)
        {
        ...
        {
            return _context.EmployeeSalary.Any(e => e.Id == id);
        }
    }
}
